...
##
## The Countdown node is a label that will display, in order, any amount of 
## strings set in the [member counting_steps] property. [br]
## Each string will be shown for [member step_duration] seconds; once all the strings
## have appeared, the [signal counting_finished] signal will be emitted.[br]
## Once the countdown finishes, it will hide on its own until [member start_counting]
## is called again.[br]
## [br]
